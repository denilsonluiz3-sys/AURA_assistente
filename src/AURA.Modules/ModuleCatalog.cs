    ...
    public static class ModuleCatalog
    {
        ...
        private static readonly List<ModuleInfo> Modules = new List<ModuleInfo>
        {
            ...
            new ModuleInfo
            {
                ...
                Icon = "[B]",
                ShortDescription = "Navegador integrado com buscador multi-servidor, busca de imagem reversa e VPN.",
                IsCore = true,
                Features = new List<string> { "Navegador Web", "Buscador (7 provedores)", "Imagem reversa", "VPN", "Acesso privado (.onion)" },
